...
class Scholarship(models.Model):
    ...
    time_percent=models.PositiveSmallIntegerField(verbose_name="奖励档位(时间百分比)",help_text="只填百分之,如80,代表80%")
...
class Course(models.Model):
    ...
    degree_course=models.TextField(verbose_name="课程概述",max_length=2048)
    ...
    template_id=models.SmallIntegerField("前端模板_id",default=1)
